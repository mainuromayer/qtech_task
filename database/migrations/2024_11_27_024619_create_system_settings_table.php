...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('system_settings', function (Blueprint $table) {
            ...
            $table->string('logo', 255)->default('https://tuto-photos.com/wp-content/plugins/sfwd-lms/assets/images/nologo.jpg');
            ...
            $table->string('admin_logo', 255)->default('https://tuto-photos.com/wp-content/plugins/sfwd-lms/assets/images/nologo.jpg');
