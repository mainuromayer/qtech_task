...
<div class="container-fluid">
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Job Categories</h4>
        </div>
        <div class="text-end">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title mb-0">Job Category List</h5>
                    <a href="{{ route('job_category.create') }}" class="btn btn-primary">
                        Add New
                    </a>
                </div>
...
function showStatusChangeAlert(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            let url = '{{ route("job_category.status", ":id") }}';
...
function showDeleteConfirm(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            let url = '{{ route("job_category.destroy", ":id") }}';
            $.ajax({
                type: "DELETE",
